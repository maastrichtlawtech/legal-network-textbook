            ...
            <button id="github">
                <a type="button" href="https://github.com/maastrichtlawtech/legal-network-textbook" target="_blank">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="3840.000000pt" height="2160.000000pt"
                        ...
                        <g transform="translate(0.000000,2160.000000) scale(0.100000,-0.100000)" fill="#000000"
                            stroke="none">
...
defineProps({
    tocItems: Array<Array<{ label: String, url: String }>>
});
...
aside>#buttons>#github * svg {
    height: 60px;
    width: 60px;
}

aside>#buttons>#github * svg>g {
    fill: black;
    transition: fill .25s ease-out !important;
    -moz-transition: fill .25s ease-out !important;
    -webkit-transition: fill .25s ease-out !important;
    -o-transition: fill .25s ease-out !important;
    padding: 0;
}

aside>#buttons>#github:hover * svg>g {
    fill: #484747;
}

aside>#buttons>#github {
    border-radius: 10px;
    border: 1px solid;
